...
pj_bool_t pjsua_call_on_incoming(pjsip_rx_data *rdata)
{
    ...
    if(pjsua_var.acc[acc_id].cfg.use_siprec == PJSUA_SIP_TIMER_MANDATORY){
        printf("################### PJSUA_SIP_TIMER_MANDATORY \n");
    }
    if(pjsua_var.acc[acc_id].cfg.use_siprec == PJSUA_SIP_SIPREC_OPTIONAL){
        printf("################### PJSUA_SIP_SIPREC_OPTIONAL \n");
    }
    if(pjsua_var.acc[acc_id].cfg.use_siprec == PJSUA_SIP_SIPREC_INACTIVE){
        printf("################### PJSUA_SIP_SIPREC_INACTIVE \n");
    }
