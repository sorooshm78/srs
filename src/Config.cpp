...
void Config::loadJsonConfig()
{
    ...
    {
        std::cout << "Warn: Cannot open configuration file: " << Config::configFilePath
                  << std::endl;
    }
...
void Config::setVariableFromConfigFile(const nlohmann::json& config, const std::string& key,
                                       std::string& variable)
{
